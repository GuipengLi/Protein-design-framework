...
def train_model( prename):
    ...
    train_loader = DataLoader_NIPS19( data_dict['train'], batch_size=batch_size, shuffle=True, num_workers=4, collate_fn= featurize_NIPS19)
    ...
    outname = 'models/%s_16_%s.pth'%(prename, time.ctime()) 
    print(outname)
